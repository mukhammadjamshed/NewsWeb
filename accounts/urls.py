...
from .views import user_login, dashboard_view, user_register, user_edit, UserEditView
...
urlpatterns = [
    ...
    path('profile/edit/', user_edit, name='edit_user_profile'),
    # path('profile/edit/', UserEditView.as_view(), name='edit_user_profile'),
